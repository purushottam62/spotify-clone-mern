...
let atifAslam = [
  {
    songNameOfSongs: "O Meri Laila",
    filePath: "atif aslam/o meri laila.mp3",
    coverPath: "atif aslam images/o meri laila.jpg",
    duration: "03:11", // (example duration, adjust accordingly)
  },
  {
    songNameOfSongs: "Dekhte Dekhte",
    filePath: "atif aslam/dekhte dekhte.mp3",
    coverPath: "atif aslam images/dekhte dekhte.jpg",
    duration: "04:16", // (example duration)
  },
  {
    songNameOfSongs: "Dil Diyan Gallan",
    filePath: "atif aslam/dil diyan gallan.mp3",
    coverPath: "atif aslam images/dil diyan gallan.jpg",
    duration: "04:20", // (example duration)
  },
  {
    songNameOfSongs: "Jab Koi Baat",
    filePath: "atif aslam/jab koi baat.mp3",
    coverPath: "atif aslam images/jab koi baat.jpg",
    duration: "03:12", // (example duration)
  },
  {
    songNameOfSongs: "Jeena Jeena",
    filePath: "atif aslam/jeena jeena.mp3",
    coverPath: "atif aslam images/jeena jeena.jpg",
    duration: "03:49", // (example duration)
  },
  {
    songNameOfSongs: "Jeene Laga Hoon",
    filePath: "atif aslam/jeene laga hoon.mp3",
    coverPath: "atif aslam images/jeene laga hoon.jpg",
    duration: "03:56", // (example duration)
  },
  {
    songNameOfSongs: "Main Agar",
    filePath: "atif aslam/main agar.mp3",
    coverPath: "atif aslam images/main agar.jpg",
    duration: "04:39", // (example duration)
  },
  {
    songNameOfSongs: "Main Rang Sharbaton Ka",
    filePath: "atif aslam/main rang sharbat....ka.mp3",
    coverPath: "atif aslam images/main rang sharbaton ka.jpg",
    duration: "04:23", // (example duration)
  },
  {
    songNameOfSongs: "O Saathi",
    filePath: "atif aslam/o saathi.mp3",
    coverPath: "atif aslam images/o saathi.jpg",
    duration: "04:11", // (example duration)
  },
  {
    songNameOfSongs: "Paniyon Sa",
    filePath: "atif aslam/paniyon sa.mp3",
    coverPath: "atif aslam images/paniyon sa.jpg",
    duration: "03:56", // (example duration)
  },
  {
    songNameOfSongs: "Tera Hone Laga Hoon",
    filePath: "atif aslam/tera hone laga hoon.mp3",
    coverPath: "atif aslam images/tera hone laga hoon .jpg",
    duration: "05:00", // (example duration)
  },
  {
    songNameOfSongs: "Tera Hua",
    filePath: "atif aslam/tera hua.mp3",
    coverPath: "atif aslam images/tera hua.jpg",
    duration: "03:34", // (example duration)
  },
  {
    songNameOfSongs: "Tere Liye",
    filePath: "atif aslam/tere liye.mp3",
    coverPath: "atif aslam images/tere lie.jpg",
    duration: "04:39", // (example duration)
  },
  {
    songNameOfSongs: "Tere Sang Yaara",
    filePath: "atif aslam/tere sang yaara.mp3",
    coverPath: "atif aslam images/tere sang.jpg",
    duration: "04:54", // (example duration)
  },
  {
    songNameOfSongs: "Tu Chahiye",
    filePath: "atif aslam/tu chahiye.mp3",
    coverPath: "atif aslam images/tu chahiye.jpg",
    duration: "04:32", // (example duration)
  },
  {
    songNameOfSongs: "Tu Jaane Na",
    filePath: "atif aslam/tu jaane na.mp3",
    coverPath: "atif aslam images/tu jaane na.jpg",
    duration: "05:41", // (example duration)
  },
];
let rahatKhan = [];
let arijitSingh = [
